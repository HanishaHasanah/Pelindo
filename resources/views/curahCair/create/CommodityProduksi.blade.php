        ...
        <div class="col-md-8">
            ...
            <div class="card shadow-lg border-0 rounded-3">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Tambah Data Komoditas Produksi</h5>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('commodity.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="commodity_id" id="commodity_id" 
                                    class="form-control @error('commodity_id') is-invalid @enderror" required>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="{{ route('Data_CC', ['type' => 'commodity']) }}" class="btn btn-outline-secondary">
